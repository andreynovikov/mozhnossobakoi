    ...
    return (
      <Container sx={{ my: 2 }}>
        ...
        <Typography variant="body1" gutterBottom>
          ...
          но уже скоро там появятся фильтры по типу места. Ещё можно воспользоваться списком мест. Там можно фильтровать места по их типу и расположению, чтобы быстро найти то, что вам нужно.
        </Typography>
